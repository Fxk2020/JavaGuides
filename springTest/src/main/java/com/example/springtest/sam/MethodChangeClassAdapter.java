package com.example.springtest.sam;
...
public class MethodChangeClassAdapter {

    private static byte[] generate() {
        ClassWriter classWriter = new ClassWriter(0);
        // 定义对象头；版本号、修饰符、全类名、签名、父类、实现的接口
        classWriter.visit(Opcodes.V1_7, Opcodes.ACC_PUBLIC,
                "org/itstack/demo/asm/AsmHelloWorld", null, "java/lang/Object", null);
    ...
    public static void main(String[] args) {
        byte[] generate = MethodChangeClassAdapter.generate();
        for (byte ge:
             generate) {
            System.out.print(ge);
        }
